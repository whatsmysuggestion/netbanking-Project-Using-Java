...
Connection conn=null,conn1=null;
 ...
 String acctnum=(String)session.getAttribute("acctnum");
 
 int i=0;
 try{
//  Class.forName("oracle.jdbc.driver.OracleDriver");
//conn= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl","scott","tiger");
//conn1= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl","scott","tiger");
 Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
conn=DriverManager.getConnection("jdbc:odbc:netbank","root","root");

conn1=DriverManager.getConnection("jdbc:odbc:netbank","root","root");
