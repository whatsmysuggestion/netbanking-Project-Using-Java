 ...
 it_park=new Array();
 it_park[0]=["Home","home_client.htm"];
...
if(!newMenu[menuname]) {
 ...
 litems=["Teller Services","Transaction Services","Bill Payment","Requests","Maintenance Services","User Alerts","Reports"];
...
document.write('<table width=600 align=cemter cellspacing=0 cellpadding=0 border=0 bgcolor=oldlace><tr><td class=tdc valign=top><img src="netbanking.jpg" name=iobj /></td><TD width=100% id=gradient valign=middle align=center>Online Net Banking Solutions for life Time</td></tr></table>');
